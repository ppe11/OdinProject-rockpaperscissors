...
document.body.setAttribute("style", "font-family: Arial, sans-serif; text-align: center; margin: 50px; background-color: pink;");

document.querySelector(".buttons").setAttribute("style", "margin: 20px;");

document.querySelectorAll("button").forEach(button => {
    button.setAttribute("style", "font-size: 20px; margin: 10px; padding: 10px 20px; cursor: pointer;");
});
...
resetButton.setAttribute("style", "display: block; margin: 20px auto; padding: 10px 20px; font-size: 18px; cursor: pointer;");
